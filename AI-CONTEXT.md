...
- PIPA catalog 0.2.0: https://raw.githubusercontent.com/days0854/safe-vibe/main/skills/pipa-privacy/catalog.json
...
- Verified release v0.1.0: https://github.com/days0854/safe-vibe/releases/tag/v0.1.0
...
2. Read the relevant skill instructions and catalog entries before proposing implementation.
...
- Grok: use a conversation with web access and provide this URL before the task.
